...
-- 
-- Distribution:
--   LeetCode: 5 Easy, 25 Medium, 8 Hard = 38 Total
...
-- Question 31: Trapping Rain Water
-- Trapping Rain Water (HARD)
INSERT INTO questions (id, category_id, title, difficulty, description, constraints, examples, tags) VALUES
(31, 1, 'Trapping Rain Water', 'hard',
...
-- Question 32: Median of Two Sorted Arrays
-- Median of Two Sorted Arrays (HARD)
INSERT INTO questions (id, category_id, title, difficulty, description, constraints, examples, tags) VALUES
(32, 1, 'Median of Two Sorted Arrays', 'hard',
...
-- Question 33: Binary Tree Maximum Path Sum
-- Binary Tree Maximum Path Sum (HARD)
INSERT INTO questions (id, category_id, title, difficulty, description, constraints, examples, tags) VALUES
(33, 1, 'Binary Tree Maximum Path Sum', 'hard',
...
-- Question 34: Serialize and Deserialize Binary Tree
-- Serialize and Deserialize Binary Tree (HARD)
INSERT INTO questions (id, category_id, title, difficulty, description, constraints, examples, tags) VALUES
(34, 1, 'Serialize and Deserialize Binary Tree', 'hard',
...
-- Question 35: Regular Expression Matching
-- Regular Expression Matching (HARD)
INSERT INTO questions (id, category_id, title, difficulty, description, constraints, examples, tags) VALUES
(35, 1, 'Regular Expression Matching', 'hard',
...
-- Question 36: Edit Distance
-- Edit Distance (HARD)
INSERT INTO questions (id, category_id, title, difficulty, description, constraints, examples, tags) VALUES
(36, 1, 'Edit Distance', 'hard',
...
-- Question 37: Word Ladder
-- Word Ladder (HARD)
INSERT INTO questions (id, category_id, title, difficulty, description, constraints, examples, tags) VALUES
(37, 1, 'Word Ladder', 'hard',
...
-- Question 38: Expression Add Operators
-- Expression Add Operators (HARD)
INSERT INTO questions (id, category_id, title, difficulty, description, constraints, examples, tags) VALUES
(38, 1, 'Expression Add Operators', 'hard',
'Given a string num that contains only digits and an integer target, return all possibilities to insert the binary operators ''+'', ''-'', and/or ''*'' between the digits of num so that the resultant expression evaluates to the target value.

Note that operands in the returned expressions should not contain leading zeros.',
'["1 <= num.length <= 10", "num consists of only digits", "-2^31 <= target <= 2^31 - 1"]',
'[{"input": {"num": "123", "target": 6}, "output": ["1*2*3", "1+2+3"], "explanation": "Both expressions evaluate to 6."}, {"input": {"num": "232", "target": 8}, "output": ["2*3+2", "2+3*2"], "explanation": "Both evaluate to 8."}, {"input": {"num": "3456237490", "target": 9191}, "output": [], "explanation": "No valid expressions."}]',
...
'[{"input": ["123", 6], "expectedOutput": ["1*2*3", "1+2+3"]}, {"input": ["232", 8], "expectedOutput": ["2*3+2", "2+3*2"]}, {"input": ["00", 0], "expectedOutput": ["0*0", "0+0", "0-0"]}]',
'O(4^n)',
'O(n)');
...
-- Question 39: Design Content Moderation System (Meta)
-- Design Content Moderation System (Meta) (HARD)
INSERT INTO questions (id, category_id, title, difficulty, description, tags) VALUES
(39, 2, 'Design Content Moderation System (Meta)', 'hard',
'Design a real-time content moderation system for Meta/Facebook that automatically detects and filters inappropriate content (hate speech, violence, spam, misinformation) across billions of posts, comments, and media.',
'["content-moderation", "multi-modal", "classification", "real-time", "human-in-loop", "meta"]');

INSERT INTO ml_design_questions (question_id, scenario, requirements, evaluation_criteria, key_components) VALUES
(39,
'Meta needs a content moderation system that:
...
'["Real-time detection (<1s for text, <10s for media)", "Multi-modal: text, images, videos, audio", "Multi-class classification (hate speech, violence, spam, etc.)", "Multi-language support (100+ languages)", "Handle billions of items daily", "Low false positive rate (precision >95%)", "High recall for severe violations (>98%)", "Human-in-the-loop for borderline cases", "Explainable decisions for appeals", "Quick adaptation to new violation patterns", "Region-specific policies"]',
'{"problem_understanding": "Understood multi-modal, multi-class, multi-language complexity", "model_architecture": "Appropriate models for text (transformers), images (CNNs), video", "data_pipeline": "Handling labeled data, active learning, human labeling", "scalability": "Distributed inference, model serving at Meta scale", "precision_recall_tradeoff": "Strategy for balancing false positives vs negatives", "human_in_loop": "Queue management, reviewer workflow, feedback loop", "adaptation": "Online learning, handling emerging patterns", "explainability": "LIME/SHAP for appeals, policy alignment"}',
'["Multi-modal Feature Extraction", "Text Classification (BERT/RoBERTa for hate speech)", "Image/Video Classification (ResNet/EfficientNet)", "Audio Analysis (for video content)", "Ensemble Models for final decision", "Real-time Serving Infrastructure", "Human Review Queue & Workflow", "Active Learning Pipeline", "Appeal & Explanation System", "A/B Testing Framework", "Regional Policy Engine"]');


-- Question 40: Design Search/Discovery System for Atlassian Products
-- Design Search/Discovery System for Atlassian Products (MEDIUM)
INSERT INTO questions (id, category_id, title, difficulty, description, tags) VALUES
(40, 2, 'Design Search/Discovery System for Atlassian Products', 'medium',
'Design an intelligent search and discovery system for Atlassian products (Jira, Confluence) that helps users find relevant issues, pages, and projects across their workspace using natural language queries.',
'["search", "nlp", "semantic-search", "enterprise", "atlassian", "personalization"]');

INSERT INTO ml_design_questions (question_id, scenario, requirements, evaluation_criteria, key_components) VALUES
(40,
'Atlassian needs a unified search system across Jira and Confluence that:
...
'["Natural language query understanding", "Multi-source search (Jira issues, Confluence pages, comments)", "Semantic search with embeddings", "Personalized ranking based on user context", "Sub-second query latency", "Handle 100K+ issues per workspace", "Faceted search and filtering", "Auto-complete and query suggestions", "Permission-aware results", "Cross-product search integration"]',
'{"query_understanding": "NLP for intent and entity extraction from queries", "semantic_search": "Embedding models for semantic similarity", "ranking_model": "Learning-to-rank with personalization signals", "indexing_strategy": "Efficient indexing for structured and unstructured data", "personalization": "User context, project access, search history", "latency": "Optimization for sub-second response", "scalability": "Handle enterprise workspaces efficiently"}',
'["Query Understanding (NLP, Entity Extraction)", "Document Indexing (Elasticsearch)", "Semantic Embedding Models", "Hybrid Search (keyword + semantic)", "Ranking Model with Personalization", "Permission & Access Control", "Query Auto-complete", "Result Aggregation across products", "Click-through Rate tracking", "A/B Testing for ranking improvements"]');
...
-- Question 42: Design News Feed Ranking (Facebook/Instagram)
-- Design News Feed Ranking (Facebook/Instagram) (MEDIUM)
INSERT INTO questions (id, category_id, title, difficulty, description, tags) VALUES
(42, 2, 'Design News Feed Ranking (Facebook/Instagram)', 'medium',
'Design the machine learning system that ranks posts in social media news feeds to maximize user engagement.',
'["ranking", "social-media", "multi-task-learning", "personalization", "engagement", "meta"]');
...
-- Question 43: Design Google Search Ranking System
-- Design Google Search Ranking System (HARD)
INSERT INTO questions (id, category_id, title, difficulty, description, tags) VALUES
(43, 2, 'Design Google Search Ranking System', 'hard',
...
-- Question 44: Design E-commerce Product Recommendation System
-- Design E-commerce Product Recommendation System (MEDIUM)
INSERT INTO questions (id, category_id, title, difficulty, description, tags) VALUES
(44, 2, 'Design E-commerce Product Recommendation System', 'medium',
...
-- Question 45: Design Face Recognition System
-- Design Face Recognition System (MEDIUM)
INSERT INTO questions (id, category_id, title, difficulty, description, tags) VALUES
(45, 2, 'Design Face Recognition System', 'medium',
...
-- Question 46: Design Object Detection System for Autonomous Vehicles
-- Design Object Detection System for Autonomous Vehicles (HARD)
INSERT INTO questions (id, category_id, title, difficulty, description, tags) VALUES
(46, 2, 'Design Object Detection System for Autonomous Vehicles', 'hard',
...
-- Question 47: Design Machine Translation System
-- Design Machine Translation System (HARD)
INSERT INTO questions (id, category_id, title, difficulty, description, tags) VALUES
(47, 2, 'Design Machine Translation System', 'hard',
...
-- Question 48: Design Credit Card Fraud Detection System
-- Design Credit Card Fraud Detection System (MEDIUM)
INSERT INTO questions (id, category_id, title, difficulty, description, tags) VALUES
(48, 2, 'Design Credit Card Fraud Detection System', 'medium',
