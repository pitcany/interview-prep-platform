...
def main():
    ...
    print(f"   LeetCode questions: {len(LEETCODE_QUESTIONS)}")
    ...
    sql_lines = [
        ...
        "-- ",
        "-- Distribution:",
        f"--   LeetCode: {len([q for q in LEETCODE_QUESTIONS if q['difficulty'] == 'easy'])} Easy, "
        f"{len([q for q in LEETCODE_QUESTIONS if q['difficulty'] == 'medium'])} Medium, "
        f"{len([q for q in LEETCODE_QUESTIONS if q['difficulty'] == 'hard'])} Hard",
